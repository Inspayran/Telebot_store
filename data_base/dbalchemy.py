...
class DBManager(metaclass=Singleton):
    ...
    def select_single_product_quantity(self, row_num):
        ...
        result = self._session.query(
            Products.quantity).filter_by(id=row_num).one()
        self.close()
        return result.quantity
    ...
    def select_single_product_name(self, row_num):
        ...
        """
        result = self._session.query(
            Products.name).filter_by(id=row_num).one()
        self.close()
        return result.name
    ...
    def select_single_product_title(self, row_num):
        ...
        """
        result = self._session.query(
            Products.title).filter_by(id=row_num).one()
        self.close()
        return result.title
    ...
    def select_single_product_price(self, row_num):
        ...
        """
        result = self._session.query(
            Products.price).filter_by(id=row_num).one()
        self.close()
        return result.price
